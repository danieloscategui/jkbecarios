...
<nav class="navbar navbar-dark sticky-top bg-info flex-md-nowrap p-0">
	...
	<a class="navbar-brand col-sm-3- col-md-2 mr-0" href='<c:url value="/" />'>Becarios JK</a>
	
	<input class="form-control form-control-dark w-100 allow-number" type="text" maxlength="8" placeholder="Ingrese DNI" aria-label="Ingrese DNI" id="dniBecario">
	<!-- 
