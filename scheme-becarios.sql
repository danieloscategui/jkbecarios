...
DROP SEQUENCE BECARIO_SEQ;

-- CREATE TABLES
CREATE TABLE BECARIOS(
  ID_BECARIO NUMBER(5) NOT NULL,
...
ADD CONSTRAINT BECARIOS_PK PRIMARY KEY (ID_BECARIO);
...
ALTER TABLE PAGO_SUBVENCION
ADD CONSTRAINT PAGO_SUBVENCION_FK_BECARIO FOREIGN KEY (ID_BECARIO)
REFERENCES BECARIOS(ID_BECARIO);

ALTER TABLE TRAMITES
ADD CONSTRAINT TRAMITES_PK PRIMARY KEY (ID_TRAMITE);

ALTER TABLE TRAMITES
ADD CONSTRAINT TRAMITES_FK_BECARIO FOREIGN KEY (ID_BECARIO)
REFERENCES BECARIOS(ID_BECARIO);
...
ALTER TABLE CONDICION_PAGO
ADD CONSTRAINT CONDICION_PAGO_FK_BECARIO FOREIGN KEY (ID_BECARIO)
REFERENCES BECARIOS(ID_BECARIO);
